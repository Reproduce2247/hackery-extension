 ...
 * @param {unknown} error
 */
function formatScriptletError(error) {
  if (error == null) {
 ...
 */
async function executeScriptletWithBindings(tabId, code, paramValues = {}, options = {}) {
  if (!tabId) {
...
globalThis.SnLinksScriptletInject = {
  executeScriptletWithBindings,
  formatScriptletError,
};
})();
